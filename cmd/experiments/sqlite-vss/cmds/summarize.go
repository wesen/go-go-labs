...
func NewAnswerQuestionCommand() (*geppetto_cmds.PinocchioCommand, error) {
	// TODO(manuel, 2024-04-26) We could add an easier way to load just one file
	g := &geppetto_cmds.PinocchioCommandLoader{}
	...
	return cmds_[0].(*geppetto_cmds.PinocchioCommand), nil
}
